...
class QuakeGame(bs.TeamGameActivity[Player, Team]):
    ...
    def drop_shield(self):
        ...
        self._checker = bs.Timer(0.1, babase.CallStrict(check_exists), repeat=True)
        ...
        bs.timer(6.9, babase.CallStrict(del_checker))
        bs.timer(7.0, babase.CallStrict(delete_light))
